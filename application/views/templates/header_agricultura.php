...
<html>
    ...
    <div class="buttons" id="buttons">    
        ...
        <a href="<?php echo base_url() . "agricultura"; ?>" onmouseover="document.agricultura.src='<?php echo base_url() . "public/images/AGRICULTURA-01.png"; ?>'"
           onmouseout="document.agricultura.src='<?php echo base_url() . "public/images/AGRICULTURA-02.png"; ?>'" title="Canal Agricultura">
            <img name="agricultura" src=<?php echo base_url() . "public/images/AGRICULTURA-02.png"; ?> width="190px">
        </a>
