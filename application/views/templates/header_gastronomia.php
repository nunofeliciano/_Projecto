...
<html>
    ...
    <div class="buttons" id="buttons">    
        ...
        <a href="<?php echo base_url() . "vivencias"; ?>" onmouseover="document.vivencias.src='<?php echo base_url() . "public/images/VIVENCIAS-02.png"; ?>'"
           onmouseout="document.vivencias.src='<?php echo base_url() . "public/images/VIVENCIAS-01.png"; ?>'" title="Canal Vivencias">
            <img name="vivencias" src=<?php echo base_url() . "public/images/VIVENCIAS-01.png"; ?> width="190px">
        </a>

        <a href="<?php echo base_url() . "gastronomia"; ?>" onmouseover="document.gastronomia.src='<?php echo base_url() . "public/images/GASTRONOMIA-01.png"; ?>'"
           onmouseout="document.gastronomia.src='<?php echo base_url() . "public/images/GASTRONOMIA-02.png"; ?>'" title="Canal Gastronomia">
            <img name="gastronomia" src=<?php echo base_url() . "public/images/GASTRONOMIA-02.png"; ?> width="190px">
        </a>
